    ...
    methods: {
        ...
        async removeParams(attr_id){
            const confirmResult = await this.$confirm('此操作将永久删除该参数, 是否继续?', '提示', {
                ...
                if(confirmResult!=='confirm') return this.$message.error('已取消了删除')
